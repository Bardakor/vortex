...
// SAFETY: [`varying`](InputElement::varying) returns the decoded geometry slice and
// [`varying_len`](InputElement::varying_len) reports that slice's exact length.
unsafe impl InputElement for GeometryRow {
        ...
        Self: 'a,
    {
        ...
        // `varying_len` for this exact view.
